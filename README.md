# Run Tests With Bitrise on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run tests with Bitrise across real browsers and operating systems. This sample shows how to configure the TestMu AI (Formerly LambdaTest) Bitrise step library to run on the TestMu AI (Formerly LambdaTest) cloud.
